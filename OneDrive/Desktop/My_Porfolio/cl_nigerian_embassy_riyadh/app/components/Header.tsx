  ...
  return (
    <header className="w-full bg-white dark:bg-gray-950 border-b-4 border-green-700 sticky top-0 z-50 shadow-sm">
      ...
      <div className="bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 py-2 text-center text-xs sm:text-sm font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-4">
        <Link
          href="/"
          className="flex items-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-700 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-950 rounded-md"
      ...
      {/* Search row for narrow viewports */}
